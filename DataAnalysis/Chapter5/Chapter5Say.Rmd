...
#NLLS: 
modellaplaceB <- nls(Emood2 ~ laplace(Period,q,t,s), data=ex.dataB, start=list(q=0.43,t=1572, s=200))
...
modellaplaceA <- nls(Emood2 ~ laplace(Period,q,t,s), data=ex.dataA, start=list(q=0.43,t=1572, s=200))
